...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SimpleExpenseManagerApplication simpleExpenseManagerApplication = (SimpleExpenseManagerApplication) this.getApplication();
        expenseManager = new PersistentExpenseManager(simpleExpenseManagerApplication);
